...
This database context will have its own connection string (usually) separate from that of any tenant in the store.
...
Use the same overload to add resilience and transient fault handling
